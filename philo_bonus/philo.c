...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/14 17:45:26 by hdelacou          #+#    #+#             */
/*   Updated: 2025/01/17 20:43:12 by hdelacou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*death_checker(void *void_philosopher)
{
	...
	while (42)
	{
		...
		if ((timestamp() - philo->t_last_meal) > r->time_death)
		{
			action_print(r, philo->id, DIE);
			r->dieded = 1;
			sem_wait(r->writing);
			exit(1);
		}
